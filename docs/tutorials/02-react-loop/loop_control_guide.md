...
![配图：小黑掉进一个旋转的莫比乌斯环里出不来——无限循环陷阱的隐喻](/assets/loop-control-01-infinite-loop.png)
...
![配图：小黑在操控台前，面前有六个旋钮和按钮——定时器、重拨、跳闸、阀门、电梯、流水线](/assets/loop-control-02-control-panel.png)
...
![配图：小黑站在三道闸门前——速率限制、断路器、重试策略——层层防护](/assets/loop-control-03-layered-defense.png)
