...
![配图：左边小黑每次都忘事抓头（头上有问号），右边小黑拿着笔记本自信回答](/assets/03-memory-01-amnesia-vs-memory.png)
...
![配图：小黑左手拿着便利贴（短期），右手拿着保险箱（长期）](/assets/03-memory-02-short-vs-long-term.png)
...
![配图：小黑在传送带上推消息卡片，旧的从另一端掉下去——FIFO淘汰机制](/assets/03-memory-03-fifo-queue.png)
...
![配图：小黑把对话文字倒进漏斗，底部筛出结构化信息卡片——正则提取管道](/assets/03-memory-04-info-extraction.png)
